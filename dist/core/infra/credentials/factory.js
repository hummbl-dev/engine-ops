    ...
    static async getInstance() {
        ...
        switch (provider) {
            case 'vault':
                ...
                this.instance = new vault_1.VaultCredentialsManager(process.env.VAULT_ADDR, process.env.VAULT_TOKEN);
                break;
            case 'aws':
                ...
                this.instance = new aws_1.AWSCredentialsManager(process.env.AWS_REGION, process.env.AWS_SECRET_ID);
                break;
            case 'env':
