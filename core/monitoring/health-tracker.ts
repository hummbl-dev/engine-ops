...
export class HealthTracker {
    ...
    logRemediation(event: Omit<RemediationEvent, 'timestamp'>): void {
        ...
        if (fullEvent.outcome === 'success') {
            this.logger.info('Remediation action successful', fullEvent as unknown as Record<string, unknown>);
        } else {
            this.logger.error('Remediation action failed', fullEvent as unknown as Record<string, unknown>);
        }
    }
