...
describe('AgentSessionManager', () => {
  ...
  describe('createSession', () => {
    ...
    it('should reject invalid session type', async () => {
      ...
      await expect(manager.createSession(request as AgentSessionRequest)).rejects.toThrow(
        'validation failed',
      );
    });
  });
  ...
  describe('updateSessionState', () => {
    it('should update session state', async () => {
      ...
      expect(new Date(updatedSession.updatedAt).getTime()).toBeGreaterThanOrEqual(
    ...
    it('should throw error for non-existent session', async () => {
      await expect(manager.updateSessionState('non-existent', 'running')).rejects.toThrow(
        'not found',
      );
    });
  });
