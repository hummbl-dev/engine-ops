...
class AuditAgent(Agent):
    ...
    def process(self, context: AgentContext) -> AgentContext:
        ...
        """
        self.telemetry.info(
            "Starting audit process", trace_id=context.telemetry.trace_id, agent_id=self.agent_id
        )
        ...
        # Update state
        context.update_state("audit_complete", {"audit_id": audit_report.get("audit_id")})
    ...
    def _generate_audit_report(self, context: AgentContext) -> Dict[str, Any]:
        ...
        audit_report = {
            ...
            "workflow_info": {
                ...
                "initial_state": (
                    state_transitions[0]["from_state"] if state_transitions else "unknown"
                ),
    ...
    def _create_compliance_records(
        self, context: AgentContext, audit_report: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """
