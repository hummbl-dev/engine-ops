# Council Expansion Plan: Continental & Temporal Representation
...
- **Enlightenment (1700-1800):** 0 members ✗
- **Modern (1800-1950):** 3 members ✓
- **Contemporary (1950+):** 0 members ✗
...
- **Rationale:** Fills both North America AND Enlightenment gaps
...
- **Rationale:** Fills both North America AND Contemporary gaps
- **Core Principles:** Resilience, dignity, human connection

**Recommendation:** **Benjamin Franklin** (fills 2 gaps simultaneously)
...
- **Rationale:** Revolutionary leader, strategic thinker
...
- **Rationale:** First Latin American Nobel Prize in Literature
...
- **Rationale:** Fills both South America AND Contemporary gaps
- **Core Principles:** Critical thinking, liberation through education

**Recommendation:** **Paulo Freire** (fills 2 gaps simultaneously)
...
- **Rationale:** Indigenous leader, strategic non-violence
...
- **Note:** Not ideal for Oceania, but if we need another Modern thinker

**Recommendation:** **Dame Whina Cooper** (fills 2 gaps simultaneously)
...
- **Rationale:** Bridges Islamic and Western philosophy
...
- **Rationale:** Polymath, visionary, already considered earlier
...
- **Rationale:** Great medieval philosopher and physician
- **Core Principles:** Reason and faith, medical ethics

**Recommendation:** **Ibn Rushd (Averroes)** (diverse perspective, fills Medieval gap)
...
- **Rationale:** Central Enlightenment figure
...
- **Rationale:** Fills Enlightenment gap AND adds gender diversity
...
- **Rationale:** Revolutionary thinker, fills Enlightenment gap
- **Core Principles:** Equality, human rights, abolition

**Recommendation:** **Mary Wollstonecraft** (fills Enlightenment gap AND adds gender diversity)
...
- **Rationale:** Fills both Contemporary AND potentially North America gaps
...
- **Rationale:** Fills Contemporary gap, strengthens Africa representation
...
- **Rationale:** Fills both Contemporary AND North America gaps
- **Core Principles:** Critical analysis, intellectual freedom, anti-authoritarianism

**Recommendation:** **Nelson Mandela** (fills Contemporary gap, strengthens Africa)
...
2. **Paulo Freire** (South America + Contemporary)
3. **Dame Whina Cooper** (Oceania + Contemporary)
...
5. **Mary Wollstonecraft** (Enlightenment)
...
7. Additional members as needed for balance

## Matrix Function Implementation

The `council_matrix.py` module provides:

1. **CouncilRepresentationMatrix Class**
   - Tracks all members with continent, century, region, expertise
   - Generates gap analysis
   - Creates continent × century matrix

2. **Key Methods:**
   - `get_missing_continents()` - Returns continents with no representation
   - `get_missing_centuries()` - Returns centuries with no representation
   - `get_matrix()` - Generates full continent × century matrix
   - `get_gap_analysis()` - Comprehensive analysis
...
3. **Usage:**
   ...
   new_member = CouncilMemberProfile(
       ...
       "USA",
       ["science", "philosophy", "diplomacy"]
   )
   matrix.add_member(new_member)
   matrix.print_report()
   ```
...
1. **Week 1:** Implement matrix function and run analysis
2. **Week 2:** Add Phase 1 members (3 members for continental coverage)
3. **Week 3:** Add Phase 2 members (2 members for temporal coverage)
4. **Week 4:** Review, optimize, and add Phase 3 members as needed

## Notes

- **Antarctica:** Excluded as no historical figures
- **Gender Balance:** Continue to prioritize adding women to maintain/improve balance
- **Diversity:** Consider not just geography but also:
...
2. Implement matrix function (✅ Complete)
3. Begin Phase 1 implementation
4. Test new members with sample queries
5. Update documentation
6. Announce expanded council
