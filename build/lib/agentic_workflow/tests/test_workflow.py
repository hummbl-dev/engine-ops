...
class TestWorkflowIntegration:
    ...
    def test_incident_response_workflow(self):
        ...
        assert audit["compliance_status"] in ["compliant", "non_compliant_approval_missing", "non_compliant_no_telemetry"]
        ...
        assert "issues_detected" in result.annotation.tags or len(result.payload.output_data.get("detections", [])) == 0
